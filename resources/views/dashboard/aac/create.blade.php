            ...
            <div class="content-area">
                ...
                <form action="{{ route('aac.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
                    ...
                    <div class="form-group">
                        ...
                        <small class="hint">Maksimal 5MB. JPG/PNG/WEBP yang lebih besar akan dicoba dikompres otomatis sebelum diupload.</small>
    ...
    <script>
        ...
        async function compressAacImage(file) {
            ...
            for (let attempt = 0; attempt < 10; attempt++) {
                ...
                if (!$best = bestBlob || blob.size < bestBlob.size) {
                    bestBlob = blob;
                }
