...
<head>
    ...
    <title>Tambah Panduan - Ruma Dashboard</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <header class="header-bar">
                <h1 class="header-title">Tambah Panduan</h1>
            </header>
            ...
            <div class="content-area">
                ...
                <form action="{{ route('panduan.store') }}" method="POST" class="form-container">
                    @csrf

                    <div class="section-title"><i data-lucide="book-open"></i> Informasi Panduan</div>
                    <div class="section-subtitle">Masukkan judul dan deskripsi panduan untuk membantu pengguna.</div>
                    ...
                    <div class="form-group">
                        ...
                        <span class="hint">Gunakan judul yang jelas dan mudah dipahami.</span>
                        @error('judul')
